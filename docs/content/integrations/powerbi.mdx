...
- The `dagster-powerbi` library installed in your environment
...
Dagster can automatically load all semantic models, data sources, reports, and dashboards from your Power BI workspace as asset specs. Call the <PyObject module="dagster_powerbi" method="load_powerbi_asset_specs" /> function, which returns a list of <PyObject object="AssetSpec" />s representing your Power BI assets. You can then include these asset specs in your <PyObject object="Definitions" /> object:
